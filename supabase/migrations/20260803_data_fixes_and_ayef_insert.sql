...
INSERT INTO public.funding_opportunities (
  ...
  'A milestone-based grant programme for young South African entrepreneurs, launched 26 June 2026. AYEF provides phased, non-repayable grant funding — no repayment, no equity taken. Open to entrepreneurs from idea stage and informal traders through to established small businesses. Funded through a partnership between Absa and the Tshiamo Foundation.',
  null,
  null,
