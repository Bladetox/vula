...
const FAQS = [
  {
    ...
    answer: [
      ...
      {
        type: 'heading',
        content: 'What informal businesses can access',
      },
      {
        type: 'list',
        items: [
      ...
      {
        type: 'heading',
        content: 'Why registration still matters',
      },
      {
        type: 'p',
        content:
      ...
      {
        type: 'cta',
        label: 'See funding that requires no registration',
        href: '/find?type=informal',
      },
      {
        type: 'cta',
        label: 'How to formalise your business',
        href: '/register',
        secondary: true,
      },
    ],
  },
  {
    ...
    answer: [
      ...
      {
        type: 'heading',
        content: 'The five most common rejection reasons',
      },
      {
        type: 'reasons',
        items: [
      ...
      {
        type: 'cta',
        label: 'Find funding matched to your stage',
        href: '/find',
      },
    ],
  },
  {
    ...
    answer: [
      ...
      {
        type: 'heading',
        content: 'The core document pack',
      },
      {
        type: 'doclist',
        items: [
          {
            ...
            note: 'Download from the CIPC customer portal. Keep the PDF, not a screenshot.',
          },
          {
            name: 'SARS tax clearance / compliance certificate',
            note: 'Obtain via eFiling. Valid for 12 months. Apply before you start the funding search.',
          },
          {
            name: 'B-BBEE affidavit or certificate',
            note: 'Under R10m turnover: a sworn commissioner-of-oaths affidavit is sufficient. Free to do.',
          },
          {
            name: 'Business bank account statements',
            note: 'Usually 3 to 6 months. Must be a business account, not a personal account.',
          },
          {
            name: 'Bank confirmation letter',
            note: 'A letter from your bank confirming your account details. Request at your branch or online banking.',
          },
          {
            name: 'Certified ID copies of all directors/owners',
            note: 'Certified within 3 months. Certify at a police station or post office for free.',
          },
          {
            name: 'Proof of business address',
            note: 'A utility bill, lease agreement, or bank statement showing the business address. Not older than 3 months.',
          },
          {
            name: 'Business plan or project proposal',
            note: 'Larger programmes (IDC, NEF, SEFA) require a full plan. Smaller grants often accept a 1-page summary. SEDA offers free business plan support.',
          },
          {
            name: '12-month financial projections',
            note: 'A simple monthly income and expense forecast. Templates are available from SEDA and most banks for free.',
          },
          {
            name: 'Proof of trading (if informal)',
            note: 'Invoices, receipts, supplier letters, or photos of your operation if you do not have bank statements.',
          },
        ],
      },
      {
        type: 'heading',
        content: 'Where to get free help preparing',
      },
      {
        type: 'list',
        items: [
      ...
      {
        type: 'cta',
        label: 'See what documents each programme needs',
        href: '/directory',
      },
    ],
  },
  {
    ...
    answer: [
      ...
      {
        type: 'heading',
        content: 'Funding types explained',
      },
      {
        type: 'types',
        items: [
          {
            ...
            pros: [
              ...
              'Can be used to prove viability for follow-on funding',
            ],
            cons: [
              'Highly competitive — often hundreds of applicants per slot',
              'Usually tied to specific uses (equipment, training, not salaries)',
              'Can require co-funding or matching contributions',
              'Reporting and compliance obligations after award',
            ],
          ...
          },
          {
            ...
            pros: [
              'Larger amounts available than most grants',
              'No ownership dilution',
              'Builds a credit track record for future financing',
            ],
            cons: [
              'Monthly repayments required regardless of revenue',
              'Requires collateral or surety in most cases',
              'Credit score and trading history are assessed',
            ],
          ...
          },
          {
            ...
            pros: [
              ...
              'Investor often brings networks and mentorship',
              'Right for high-growth businesses',
            ],
            cons: [
              'You give up a portion of ownership and future profit',
              'Investors expect high returns — not suited to lifestyle businesses',
              'Takes months to negotiate and close',
            ],
          ...
          },
          {
            ...
            emoji: 'Blended',
            color: { bg: 'var(--vula-gold-light)', border: '#f0d89a', accent: 'var(--vula-gold)' },
            definition:
              'A mix of grant and loan — part of the funding is a grant, part is a subsidised loan. Common in ESD and government-corporate partnerships.',
            pros: [
              'Lower effective cost than a pure loan',
              'More flexible than a pure grant',
              'Common in corporate ESD programmes',
            ],
            cons: [
              'Complex terms — read the grant/loan split carefully',
              'Often restricted to suppliers within a specific corporate value chain',
            ],
  ...
  },
  {
    ...
    answer: [
      ...
      {
        type: 'heading',
        content: 'Typical timelines by funder type',
      },
      {
        type: 'timeline',
        items: [
          {
            funder: 'Fintech / alternative lenders',
            example: 'Lula, Merchant Capital, Retail Capital',
            range: '24 hrs – 7 days',
            amount: 'R10k – R5m',
            note: 'Revenue-based, fast decisions, higher cost of capital',
          },
          {
            funder: 'Commercial banks',
            example: 'Absa, Standard Bank, FNB, Nedbank',
            range: '1 – 6 weeks',
            amount: 'R50k – R50m',
            note: 'Requires full document pack, credit assessment, often collateral',
          },
          {
            funder: 'SEFA microfinance',
            example: 'SEFA direct or intermediaries',
            range: '4 – 10 weeks',
            amount: 'R10k – R3m',
            note: 'Government DFI, more accessible but slower than banks',
          },
          {
            funder: 'Corporate ESD / grants',
            example: 'Sanlam, Old Mutual, Massmart',
            range: '6 – 16 weeks',
            amount: 'R50k – R2m',
            note: 'Competitive intake rounds, often annual or bi-annual',
          },
          {
            funder: 'Government grants (DSBD, BBSDP)',
            example: 'BBSDP, TSIBA, Seda support',
            range: '3 – 9 months',
            amount: 'R30k – R5m',
            note: 'Cost-sharing structure, extensive compliance, high competition',
          },
          {
            funder: 'DFI growth capital',
            example: 'IDC, NEF, DBSA',
            range: '6 – 18 months',
            amount: 'R1m – R500m+',
            note: 'For established, revenue-generating businesses only',
          },
        ],
      },
      {
      ...
      {
        type: 'cta',
        label: 'See all open opportunities',
        href: '/directory',
      },
    ],
  },
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {faq.answer.map((block, bi) => {
                ...
                if (block.type === 'reasons' && block.items) {
                  return (
                    <div key={bi} style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
                      {block.items.map((item: { number: string; title: string; body: string }, ii: number) => (
                        <div
                          key={ii}
                          style={{
                            display: 'flex',
                        ...
                        >
                          ...
                          <div>
                            <p style={{ fontWeight: 650, fontSize: '0.9rem', color: 'var(--vula-ink)', marginBottom: '0.3rem' }}>
                              {item.title}
                            </p>
                            <p style={{ fontSize: '0.875rem', color: 'var(--vula-muted)', lineHeight: 1.65 }}>
                              {item.body}
                            </p>
                          </div>
                        </div>
                ...
                if (block.type === 'doclist' && block.items) {
                  return (
                    <div key={bi} style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      {block.items.map((item: { name: string; note: string }, ii: number) => (
                        <div
                          key={ii}
                          style={{
                            display: 'flex',
                        ...
                        >
                          ...
                          <div>
                            <p style={{ fontWeight: 600, fontSize: '0.875rem', color: 'var(--vula-ink)', marginBottom: '0.2rem' }}>
                              {item.name}
                            </p>
                            <p style={{ fontSize: '0.8125rem', color: 'var(--vula-muted)', lineHeight: 1.55 }}>
                              {item.note}
                            </p>
                          </div>
                        </div>
                ...
                if (block.type === 'types' && block.items) {
                  return (
                    <div key={bi} style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
                      {block.items.map((item: { type: string; color: { bg: string; border: string; accent: string }; definition: string; pros: string[]; cons: string[]; examples: string }, ii: number) => (
                        <div
                          key={ii}
                          style={{
                        ...
                        >
                          <p style={{ fontWeight: 700, fontSize: '0.9375rem', color: 'var(--vula-ink)', marginBottom: '0.375rem' }}>
                            {item.type}
                          </p>
                          <p style={{ fontSize: '0.875rem', color: 'var(--vula-muted)', lineHeight: 1.6, marginBottom: '0.75rem' }}>
                            {item.definition}
                          </p>
                ...
                if (block.type === 'timeline' && block.items) {
                  return (
                    <div key={bi} style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      {block.items.map((item: { funder: string; example: string; range: string; amount: string; note: string }, ii: number) => (
                        <div
                          key={ii}
                          style={{
                            display: 'grid',
                        ...
                        >
                          <div>
                            <p style={{ fontWeight: 650, fontSize: '0.875rem', color: 'var(--vula-ink)', marginBottom: '0.15rem' }}>
                              {item.funder}
                            </p>
